...
public class DerivationBuilder {
    ...
    public Definitions getDefinitions(Builder builder) {
        ...
        Prefix OPENPROV = builder.prefix(DerivationBuilder.OPENPROV);
        ...
        Definitions result = new Definitions(XID, Box, FPC, Ownership, Recycling, Transporting, Weighing, Packing, Unpacking, PickUp, DropOff, London, Brighton, weight, foaf_name, driver, packer, unpacker, scientist, scale, Instrument, specialization, derivation, entity, previousEntity, association, generation, activity, invalidation, usage, dotColour, InsertingElement, InsertingIntoCollection, RemovingElement, RemovingElementFromCollection);
        return result;
    }
