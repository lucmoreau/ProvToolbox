    ...
    public Object convert(Tree ast) {
        switch(ast.getType()) {
            ...
            case PROV_NParser.WAT:
                ...
                id2=(QualifiedName)convert(ast.getChild(1));
                id1=(QualifiedName)convert(ast.getChild(2));
                rAttrs=OpenprovTerms.canonical(Kind.PROV_ATTRIBUTION, (List<Attribute>) convert(ast.getChild(3)), pFactory);
    ...
    public Object newExtension(Object extName, QualifiedName uid, List<Object> args, Object optionalAttributes) {
        ...
        if (NamespacePrefixMapper.isProvExt(ext.getNamespaceURI())) {
            ...
            switch (ext.getLocalPart()) {
                case "hadMember":
                    return mce.newQualifiedHadMember(uid,(QualifiedName)args.get(0), List.of((QualifiedName)args.get(1)), OpenprovTerms.canonical(Kind.PROV_MEMBERSHIP, (List<Attribute>)optionalAttributes, pFactory));
                case "specializationOf":
                    return mce.newQualifiedSpecializationOf(uid,(QualifiedName)args.get(0), (QualifiedName)args.get(1), OpenprovTerms.canonical(Kind.PROV_SPECIALIZATION, (List<Attribute>)optionalAttributes, pFactory));
                case "alternateOf":
                    return mce.newQualifiedAlternateOf(uid,(QualifiedName)args.get(0), (QualifiedName)args.get(1), (List<Attribute>)optionalAttributes);
            }
