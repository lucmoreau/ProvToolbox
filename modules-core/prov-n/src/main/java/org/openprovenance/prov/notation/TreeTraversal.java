    ...
    public Object newExtension(Object extName, QualifiedName uid, List<Object> args, Object optionalAttributes) {
        ...
        if (NamespacePrefixMapper.PROV_EXT_NS.equals(ext.getNamespaceURI())) {
            ...
            switch (ext.getLocalPart()) {
                case "hadMember":
                    return mce.newQualifiedHadMember(uid,(QualifiedName)args.get(0), List.of((QualifiedName)args.get(1)), (List<Attribute>)optionalAttributes);
                case "specializationOf":
                    return mce.newQualifiedSpecializationOf(uid,(QualifiedName)args.get(0), (QualifiedName)args.get(1), (List<Attribute>)optionalAttributes);
                case "alternateOf":
