        ...
        (function (prov) {
            ...
            (function (vanilla) {
                class WasInvalidatedBy {
                    ...
                    static u_$LI$() { if (WasInvalidatedBy.u == null) {
                        WasInvalidatedBy.u = new org.openprovenance.prov.vanilla.ProvUtilities();
                    } return WasInvalidatedBy.u; }
                    /**
                     *
                     * @param {*} aid
                     */
                    ...
                    equals$java_lang_Object$org_openprovenance_apache_commons_lang_builder_EqualsBuilder(object, equalsBuilder) {
                        if (!(object != null && object instanceof org.openprovenance.prov.vanilla.WasInvalidatedBy)) {
                    ...
                    setIndexedAttributes(qn, attributes) {
                        const values = ([]);
                        WasInvalidatedBy.u_$LI$().distribute(qn, attributes, this.getLabel(), values, this.getLocation(), this.getType(), this.getRole(), this.getOther());
                    }
                    /**
                     *
                     * @return {*}
                ...
                vanilla.WasInvalidatedBy = WasInvalidatedBy;
