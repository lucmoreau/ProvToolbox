...
namespace org.openprovenance.prov.model {
     ...
     * @class
     */
    export interface HadMember extends org.openprovenance.prov.model.Relation, org.openprovenance.prov.model.UnqualifiedRelation {
        /**
         ...
         */
        getCollection(): org.openprovenance.prov.model.QualifiedName;
         ...
         * 
         */
        getEntity(): Array<org.openprovenance.prov.model.QualifiedName>;
         ...
         * 
         */
        setCollection(collection: org.openprovenance.prov.model.QualifiedName);
    }
}
