...
namespace org.openprovenance.prov.vanilla {
    export class QualifiedSpecializationOf implements org.openprovenance.prov.model.extension.QualifiedSpecializationOf, org.openprovenance.apache.commons.lang.builder.Equals, org.openprovenance.apache.commons.lang.builder.HashCode, org.openprovenance.apache.commons.lang.builder.ToString, org.openprovenance.prov.vanilla.HasAttributes {
        ...
        specific: org.openprovenance.prov.model.QualifiedName;
        ...
        public constructor(id?: any, specificEntity?: any, generalEntity?: any, attributes?: any) {
            ...
            } else if (id === undefined && specificEntity === undefined && generalEntity === undefined && attributes === undefined) {
                let __args = arguments;
                if (this.specific === undefined) { this.specific = null; } 
                if (this.generalEntity === undefined) { this.generalEntity = null; } 
                this.id = null;
         ...
         * @param {*} specific
         */
        public setSpecificEntity(specific: org.openprovenance.prov.model.QualifiedName) {
         ...
         * @param {*} informant
         */
        public setGeneralEntity(informant: org.openprovenance.prov.model.QualifiedName) {
        ...
        public equals$java_lang_Object$org_openprovenance_apache_commons_lang_builder_EqualsBuilder(object: any, equalsBuilder: org.openprovenance.apache.commons.lang.builder.EqualsBuilder) {
            ...
            const that: QualifiedSpecializationOf = (<QualifiedSpecializationOf>object);
        ...
        public equals2(object: any, equalsBuilder: org.openprovenance.apache.commons.lang.builder.EqualsBuilder) {
            ...
            const that: org.openprovenance.prov.vanilla.SpecializationOf = (<org.openprovenance.prov.vanilla.SpecializationOf>object);
            equalsBuilder.append$java_lang_Object$java_lang_Object(this.getSpecificEntity(), that.getSpecificEntity());
            equalsBuilder.append$java_lang_Object$java_lang_Object(this.getGeneralEntity(), that.getGeneralEntity());
        }
            ...
            if (!(object != null && object instanceof <any>org.openprovenance.prov.vanilla.QualifiedSpecializationOf)){
                if (object != null && object instanceof <any>org.openprovenance.prov.vanilla.SpecializationOf){
                    if (this.isUnqualified()){
                        const qspec: org.openprovenance.prov.vanilla.SpecializationOf = <org.openprovenance.prov.vanilla.SpecializationOf>object;
