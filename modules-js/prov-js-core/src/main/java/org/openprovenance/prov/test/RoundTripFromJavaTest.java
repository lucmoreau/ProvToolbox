package org.openprovenance.prov.test;
...
public class RoundTripFromJavaTest  {
    ...
    public static  org.openprovenance.prov.model.Name fname = pFactory.getName();
    
    public org.openprovenance.prov.model.QualifiedName q(String n) {
        return pFactory.newQualifiedName(EX_NS, n, EX_PREFIX);
    }

    public void makeDocAndTest(StatementOrBundle s, String label) {
        console.log(label);
        ...
        ns.register(EX2_PREFIX, EX2_NS);
        doc.setNamespace(ns);
        makeDocAndTest(doc,label);
    }
    public void makeDocAndTest(Document doc, String label) {
        final String docString = new org.openprovenance.prov.json.ProvSerialiser(pFactory).serialiseDocument(doc);
        Document doc2=new ProvDeserialiser(pFactory).deserialiseDocument(docString);
        if (!(doc.equals(doc2))) {
            new RuntimeException("check failed for " + label);
        }
    }
    ...
    public void makeDocAndTest(Statement[] stment, Bundle[] bundles, String label, Object o, boolean b) {
        console.log(label);
        Document doc = pFactory.newDocument();
    ...
    public void makeDocAndTest(Statement[] statements, Object o, String label) {
        console.log(label);
        Document doc = pFactory.newDocument();
        for (Statement s: statements) doc.getStatementOrBundle().add(s);
        Namespace ns = new Namespace();
        ns.addKnownNamespaces();
        ns.register(EX_PREFIX, EX_NS);
        ns.register(EX2_PREFIX, EX2_NS);
    ...
    public void testAll () {
        ...
        testMembership2() ;
        testMembership3() ;
     /*   testScruffyGeneration1() ;
        testScruffyGeneration2() ;
        testScruffyInvalidation1() ;
        testScruffyInvalidation2() ;
        testScruffyUsage1() ;
        testScruffyUsage2() ;
        testScruffyStart1() ;
        testScruffyStart2() ;
      ...
      */
        ...
        testBundle3() ;
        testBundle4() ;
      /*  testDictionaryInsertion1() ;
        testDictionaryInsertion2() ;
        testDictionaryInsertion3() ;
        testDictionaryInsertion4() ;
        testDictionaryInsertion5() ;
        testDictionaryInsertion6() ;
        testDictionaryInsertion7() ;
        testDictionaryRemoval1() ;
        testDictionaryRemoval2() ;
        testDictionaryRemoval3() ;
        testDictionaryRemoval4() ;
        testDictionaryRemoval5() ;
        testDictionaryMembership2() ;
        testDictionaryMembership3() ;
        testDictionaryMembership4() ;

       */

        /*
        testQualifiedSpecializationOf1() ;
        testQualifiedSpecializationOf2() ;
        testQualifiedAlternateOf1() ;
        testQualifiedAlternateOf2() ;
        testQualifiedHadMember1() ;
        testQualifiedHadMember2() ;
    ...
    public void addTypes(HasType ht) {
        ht.getType().add(pFactory.newType("a", fname.XSD_STRING));
        ht.getType().add(pFactory.newType(1, fname.XSD_INT));
        ht.getType().add(pFactory.newType(1.0, fname.XSD_FLOAT));
        ht.getType().add(pFactory.newType(true, fname.XSD_BOOLEAN));

        ht.getType().add(pFactory.newType(pFactory.newQualifiedName(EX_NS, "abc", EX_PREFIX),
                fname.PROV_QUALIFIED_NAME));
    ...
    public void addLocations(HasLocation hl) {
        hl.getLocation().add(pFactory.newLocation("London",
                fname.XSD_STRING));
        hl.getLocation().add(pFactory.newLocation(1, fname.XSD_INT));
        hl.getLocation().add(pFactory.newLocation(1.0, fname.XSD_FLOAT));
        hl.getLocation()
                .add(pFactory.newLocation(true, fname.XSD_BOOLEAN));
        ...
        hl.getLocation().add(pFactory.newLocation(EX_NS + "london",
                fname.XSD_ANY_URI));
      //  hl.getLocation().add(pFactory.newLocation(pFactory.newGYear(2002), ??LUC
       //         fname.XSD_GYEAR));
    }
    ...
    public void addFurtherAttributes(HasOther he) {
        ...
        he.getOther().add(pFactory.newOther(EX_NS, "tag1", EX_PREFIX, "bonjour",
                fname.XSD_STRING));
  //      he.getOther().add(pFactory.newOther(EX_NS, "tag1", EX_PREFIX, pFactory.newGYear(2002), //LUC
   //             fname.XSD_GYEAR));
    ...
    public void addFurtherAttributes0(HasOther he) {
        he.getOther().add(pFactory.newOther(EX_NS, "tag1", EX_PREFIX, "hello", fname.XSD_STRING));
        he.getOther().add(pFactory.newOther(EX_NS, "tag2", EX_PREFIX, "bye", fname.XSD_STRING));
        he.getOther()
    ...
    public void NOtestRoles() {
        Role r1 = pFactory.newRole("otherRole", fname.XSD_STRING);
        Role r2 = pFactory.newRole("otherRole", fname.XSD_STRING);
    ...
    public void testEntity0() {
        ...
        a.getOther()
                .add(pFactory.newOther(pFactory.newQualifiedName(EX_NS, "tag2", EX_PREFIX),
                        pFactory.newInternationalizedString("bonjour",
                                "fr"),
                        fname.PROV_LANG_STRING));

        if (test) {

            a.getLocation().add(pFactory.newLocation("un llieu",
                    fname.XSD_STRING));
            a.getLocation().add(pFactory.newLocation(1, fname.XSD_INT));
            a.getLocation()
                    .add(pFactory.newLocation(2.0, fname.XSD_DOUBLE));
    ...
    public void testAgent7() {
        ...
        a.getLocation().add(pFactory.newLocation("London",
                fname.XSD_STRING));
        a.getLocation().add(pFactory.newLocation(1, fname.XSD_INT));
        a.getLocation().add(pFactory.newLocation(1.0, fname.XSD_FLOAT));
        a.getLocation().add(pFactory.newLocation(true, fname.XSD_BOOLEAN));
        // a.getLocation().add(pFactory.newLocation(new QName(EX_NS, "london",
        // EX_PREFIX),vconv));
        a.getLocation().add(pFactory.newLocation(pFactory.newTimeNow(),
                fname.XSD_DATETIME));
        a.getLocation().add(pFactory.newLocation(EX_NS+"london", fname.XSD_ANY_URI));
    ...
    public void testGeneration3() {
        WasGeneratedBy gen = pFactory.newWasGeneratedBy(q("gen3"), q("e1"),
                "somerole", q("a1"));
        gen.getRole().add(pFactory.newRole("otherRole", fname.XSD_STRING));
    ...
    public void testUsage3() {
        ...
        use.getRole().add(pFactory.newRole("otherRole", fname.XSD_STRING));
    ...
    public void testInvalidation3() {
        WasInvalidatedBy inv = pFactory.newWasInvalidatedBy(q("inv3"), q("e1"),
                q("a1"));
        inv.getRole().add(pFactory.newRole("someRole", fname.XSD_STRING));
        inv.getRole().add(pFactory.newRole("otherRole", fname.XSD_STRING));
    ...
    public void testStart8() {
        ...
        start.setTime(pFactory.newTimeNow());
        start.getRole()
                .add(pFactory.newRole("someRole", fname.XSD_STRING));
        start.getRole()
                .add(pFactory.newRole("otherRole", fname.XSD_STRING));
        addTypes(start);
        addLocations(start);
        addLabels(start);
    ...
    public void testEnd8() {
        ...
        end.getRole().add(pFactory.newRole("someRole", fname.XSD_STRING));
        end.getRole().add(pFactory.newRole("otherRole", fname.XSD_STRING));
        addTypes(end);
        addLocations(end);
        addLabels(end);
