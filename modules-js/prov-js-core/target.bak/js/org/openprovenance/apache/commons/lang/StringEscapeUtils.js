            ...
            (function (commons) {
                ...
                (function (lang) {
                    ...
                    class StringEscapeUtils {
                        ...
                        static CSV_QUOTE_STR_$LI$() { if (StringEscapeUtils.CSV_QUOTE_STR == null) {
                            StringEscapeUtils.CSV_QUOTE_STR = /* valueOf */ String(StringEscapeUtils.CSV_QUOTE).toString();
                        } return StringEscapeUtils.CSV_QUOTE_STR; }
                        static CSV_SEARCH_CHARS_$LI$() { if (StringEscapeUtils.CSV_SEARCH_CHARS == null) {
                            StringEscapeUtils.CSV_SEARCH_CHARS = [StringEscapeUtils.CSV_DELIMITER, StringEscapeUtils.CSV_QUOTE, org.openprovenance.apache.commons.lang.CharUtils.CR, org.openprovenance.apache.commons.lang.CharUtils.LF];
                        } return StringEscapeUtils.CSV_SEARCH_CHARS; }
                        static escapeJava$java_lang_String(str) {
                            return StringEscapeUtils.escapeJavaStyleString$java_lang_String$boolean$boolean(str, false, false);
                        }
                        static escapeJava$java_io_Writer$java_lang_String(out, str) {
                         ...
                         */
                        static escapeJava(out, str) {
                            if (((out != null && out instanceof java.io.Writer) || out === null) && ((typeof str === 'string') || str === null)) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.escapeJava$java_io_Writer$java_lang_String(out, str);
                            }
                            else if (((typeof out === 'string') || out === null) && str === undefined) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.escapeJava$java_lang_String(out);
                            }
                            else
                                throw new Error('invalid overload');
                        }
                        static escapeJavaScript$java_lang_String(str) {
                            return StringEscapeUtils.escapeJavaStyleString$java_lang_String$boolean$boolean(str, true, true);
                        }
                        static escapeJavaScript$java_io_Writer$java_lang_String(out, str) {
                         ...
                         * @throws IOException if error occurs on underlying Writer
                         */
                        static escapeJavaScript(out, str) {
                            if (((out != null && out instanceof java.io.Writer) || out === null) && ((typeof str === 'string') || str === null)) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.escapeJavaScript$java_io_Writer$java_lang_String(out, str);
                            }
                            else if (((typeof out === 'string') || out === null) && str === undefined) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.escapeJavaScript$java_lang_String(out);
                            }
                            else
                                throw new Error('invalid overload');
                        }
                        /*private*/ static escapeJavaStyleString$java_lang_String$boolean$boolean(str, escapeSingleQuotes, escapeForwardSlash) {
                            if (str == null) {
                                return null;
                            }
                            try {
                                const writer = new java.io.StringWriter(str.length * 2);
                        ...
                        static escapeJavaStyleString$java_io_Writer$java_lang_String$boolean$boolean(out, str, escapeSingleQuote, escapeForwardSlash) {
                            if (out == null) {
                            ...
                            for (let i = 0; i < sz; i++) {
                                {
                                    ...
                                    if ((c => c.charCodeAt == null ? c : c.charCodeAt(0))(ch) > 4095) {
                                        out.write("\\u" + StringEscapeUtils.hex(ch));
                                    }
                                    else if ((c => c.charCodeAt == null ? c : c.charCodeAt(0))(ch) > 255) {
                                        out.write("\\u0" + StringEscapeUtils.hex(ch));
                                    }
                                    else if ((c => c.charCodeAt == null ? c : c.charCodeAt(0))(ch) > 127) {
                                        out.write("\\u00" + StringEscapeUtils.hex(ch));
                                    }
                                    else if ((c => c.charCodeAt == null ? c : c.charCodeAt(0))(ch) < 32) {
                                        switch ((ch).charCodeAt(0)) {
                                            ...
                                            case 13 /* '\r' */:
                                                ...
                                                break;
                                            default:
                                                if ((c => c.charCodeAt == null ? c : c.charCodeAt(0))(ch) > 15) {
                                                    out.write("\\u00" + StringEscapeUtils.hex(ch));
                                                }
                                                else {
                         ...
                         * @private
                         */
                        static escapeJavaStyleString(out, str, escapeSingleQuote, escapeForwardSlash) {
                            if (((out != null && out instanceof java.io.Writer) || out === null) && ((typeof str === 'string') || str === null) && ((typeof escapeSingleQuote === 'boolean') || escapeSingleQuote === null) && ((typeof escapeForwardSlash === 'boolean') || escapeForwardSlash === null)) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.escapeJavaStyleString$java_io_Writer$java_lang_String$boolean$boolean(out, str, escapeSingleQuote, escapeForwardSlash);
                            }
                                ...
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.escapeJavaStyleString$java_lang_String$boolean$boolean(out, str, escapeSingleQuote);
                            }
                            else
                                throw new Error('invalid overload');
                        }
                         ...
                         * @private
                         */
                        /*private*/ static hex(ch) {
                            return /* toUpperCase */ javaemul.internal.IntegerHelper.toHexString(ch).toUpperCase();
                        }
                        static unescapeJava$java_lang_String(str) {
                            if (str == null) {
                                return null;
                            }
                            try {
                                const writer = new java.io.StringWriter(str.length);
                        ...
                        static unescapeJava$java_io_Writer$java_lang_String(out, str) {
                            if (out == null) {
                                throw Object.defineProperty(new Error("The Writer must not be null"), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.lang.Object', 'java.lang.RuntimeException', 'java.lang.IllegalArgumentException', 'java.lang.Exception'] });
                            }
                            if (str == null) {
                            ...
                            const sz = str.length;
                            const unicode = new org.openprovenance.apache.commons.lang.text.StrBuilder(4);
                            let hadSlash = false;
                            let inUnicode = false;
                            for (let i = 0; i < sz; i++) {
                                {
                                    ...
                                    if (inUnicode) {
                                        ...
                                        if (unicode.length() === 4) {
                                            try {
                                                const value = parseInt(unicode.toString(), 16);
                                    ...
                                    else if ((c => c.charCodeAt == null ? c : c.charCodeAt(0))(ch) == '\\'.charCodeAt(0)) {
                                        hadSlash = true;
                                        continue;
                                    }
                                    out.write((ch).charCodeAt(0));
                         ...
                         * @throws IOException if error occurs on underlying Writer
                         */
                        static unescapeJava(out, str) {
                            if (((out != null && out instanceof java.io.Writer) || out === null) && ((typeof str === 'string') || str === null)) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.unescapeJava$java_io_Writer$java_lang_String(out, str);
                            }
                            else if (((typeof out === 'string') || out === null) && str === undefined) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.unescapeJava$java_lang_String(out);
                            }
                            else
                                throw new Error('invalid overload');
                        }
                        static unescapeJavaScript$java_lang_String(str) {
                            return StringEscapeUtils.unescapeJava$java_lang_String(str);
                        }
                        static unescapeJavaScript$java_io_Writer$java_lang_String(out, str) {
                         ...
                         * @throws IOException if error occurs on underlying Writer
                         */
                        static unescapeJavaScript(out, str) {
                            if (((out != null && out instanceof java.io.Writer) || out === null) && ((typeof str === 'string') || str === null)) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.unescapeJavaScript$java_io_Writer$java_lang_String(out, str);
                            }
                            else if (((typeof out === 'string') || out === null) && str === undefined) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.unescapeJavaScript$java_lang_String(out);
                            }
                            else
                                throw new Error('invalid overload');
                        }
                        static escapeHtml$java_lang_String(str) {
                            if (str == null) {
                                return null;
                            }
                            try {
                                const writer = new java.io.StringWriter(((str.length * 1.5) | 0));
                        ...
                        static escapeHtml$java_io_Writer$java_lang_String(writer, string) {
                            if (writer == null) {
                                throw Object.defineProperty(new Error("The Writer must not be null."), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.lang.Object', 'java.lang.RuntimeException', 'java.lang.IllegalArgumentException', 'java.lang.Exception'] });
                            }
                            if (string == null) {
                         ...
                         */
                        static escapeHtml(writer, string) {
                            if (((writer != null && writer instanceof java.io.Writer) || writer === null) && ((typeof string === 'string') || string === null)) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.escapeHtml$java_io_Writer$java_lang_String(writer, string);
                            }
                            else if (((typeof writer === 'string') || writer === null) && string === undefined) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.escapeHtml$java_lang_String(writer);
                            }
                            else
                                throw new Error('invalid overload');
                        }
                        static unescapeHtml$java_lang_String(str) {
                            if (str == null) {
                                return null;
                            }
                            try {
                        ...
                        static unescapeHtml$java_io_Writer$java_lang_String(writer, string) {
                            if (writer == null) {
                                throw Object.defineProperty(new Error("The Writer must not be null."), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.lang.Object', 'java.lang.RuntimeException', 'java.lang.IllegalArgumentException', 'java.lang.Exception'] });
                            }
                            if (string == null) {
                         ...
                         * @see #escapeHtml(String)
                         */
                        static unescapeHtml(writer, string) {
                            if (((writer != null && writer instanceof java.io.Writer) || writer === null) && ((typeof string === 'string') || string === null)) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.unescapeHtml$java_io_Writer$java_lang_String(writer, string);
                            }
                            else if (((typeof writer === 'string') || writer === null) && string === undefined) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.unescapeHtml$java_lang_String(writer);
                            }
                            else
                                throw new Error('invalid overload');
                        }
                        static escapeXml$java_io_Writer$java_lang_String(writer, str) {
                            if (writer == null) {
                                throw Object.defineProperty(new Error("The Writer must not be null."), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.lang.Object', 'java.lang.RuntimeException', 'java.lang.IllegalArgumentException', 'java.lang.Exception'] });
                            }
                            if (str == null) {
                         ...
                         */
                        static escapeXml(writer, str) {
                            if (((writer != null && writer instanceof java.io.Writer) || writer === null) && ((typeof str === 'string') || str === null)) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.escapeXml$java_io_Writer$java_lang_String(writer, str);
                            }
                            else if (((typeof writer === 'string') || writer === null) && str === undefined) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.escapeXml$java_lang_String(writer);
                            }
                            else
                                throw new Error('invalid overload');
                        }
                        static escapeXml$java_lang_String(str) {
                            if (str == null) {
                                return null;
                            }
                            return org.openprovenance.apache.commons.lang.Entities.XML_$LI$().escape$java_lang_String(str);
                        }
                        static unescapeXml$java_io_Writer$java_lang_String(writer, str) {
                            if (writer == null) {
                                throw Object.defineProperty(new Error("The Writer must not be null."), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.lang.Object', 'java.lang.RuntimeException', 'java.lang.IllegalArgumentException', 'java.lang.Exception'] });
                            }
                            if (str == null) {
                         ...
                         */
                        static unescapeXml(writer, str) {
                            if (((writer != null && writer instanceof java.io.Writer) || writer === null) && ((typeof str === 'string') || str === null)) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.unescapeXml$java_io_Writer$java_lang_String(writer, str);
                            }
                            else if (((typeof writer === 'string') || writer === null) && str === undefined) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.unescapeXml$java_lang_String(writer);
                            }
                            else
                                throw new Error('invalid overload');
                        }
                        static unescapeXml$java_lang_String(str) {
                            if (str == null) {
                                return null;
                            }
                        ...
                        static escapeCsv$java_lang_String(str) {
                        ...
                        static escapeCsv$java_io_Writer$java_lang_String(out, str) {
                            if (org.openprovenance.apache.commons.lang.StringUtils.containsNone$java_lang_String$char_A(str, StringEscapeUtils.CSV_SEARCH_CHARS_$LI$())) {
                                if (str != null) {
                                    out.write(str);
                                }
                            ...
                            for (let i = 0; i < str.length; i++) {
                                {
                                    ...
                                    if ((c => c.charCodeAt == null ? c : c.charCodeAt(0))(c) == (c => c.charCodeAt == null ? c : c.charCodeAt(0))(StringEscapeUtils.CSV_QUOTE)) {
                                        out.write((StringEscapeUtils.CSV_QUOTE).charCodeAt(0));
                                    }
                         ...
                         * @since 2.4
                         */
                        static escapeCsv(out, str) {
                            if (((out != null && out instanceof java.io.Writer) || out === null) && ((typeof str === 'string') || str === null)) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.escapeCsv$java_io_Writer$java_lang_String(out, str);
                            }
                            else if (((typeof out === 'string') || out === null) && str === undefined) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.escapeCsv$java_lang_String(out);
                            }
                            else
                                throw new Error('invalid overload');
                        }
                        static unescapeCsv$java_lang_String(str) {
                            if (str == null) {
                                return null;
                            }
                            try {
                        ...
                        static unescapeCsv$java_io_Writer$java_lang_String(out, str) {
                            if (str == null) {
                                return;
                            }
                            if (str.length < 2) {
                            ...
                            if ((c => c.charCodeAt == null ? c : c.charCodeAt(0))(str.charAt(0)) != (c => c.charCodeAt == null ? c : c.charCodeAt(0))(StringEscapeUtils.CSV_QUOTE) || (c => c.charCodeAt == null ? c : c.charCodeAt(0))(str.charAt(str.length - 1)) != (c => c.charCodeAt == null ? c : c.charCodeAt(0))(StringEscapeUtils.CSV_QUOTE)) {
                                out.write(str);
                                return;
                            }
                            const quoteless = str.substring(1, str.length - 1);
                         ...
                         * @since 2.4
                         */
                        static unescapeCsv(out, str) {
                            if (((out != null && out instanceof java.io.Writer) || out === null) && ((typeof str === 'string') || str === null)) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.unescapeCsv$java_io_Writer$java_lang_String(out, str);
                            }
                            else if (((typeof out === 'string') || out === null) && str === undefined) {
                                return org.openprovenance.apache.commons.lang.StringEscapeUtils.unescapeCsv$java_lang_String(out);
                            }
                            else
                                throw new Error('invalid overload');
                        }
                    }
                    StringEscapeUtils.CSV_DELIMITER = ',';
                    StringEscapeUtils.CSV_QUOTE = '\"';
