                                            ...
                                            if (existing != null && (existing instanceof Array)) {
                                                ...
                                                /* put */ ((m, k, v) => { if (m.entries == null)
                                                    ...
                                                    if (m.entries[i].key == null && k == null || m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                                                        m.entries[i].value = v;
                                                        return;
                                                    } m.entries.push({ key: k, value: v, getKey: function () { return this.key; }, getValue: function () { return this.value; } }); })(hash, attribute, values);
                                            }
                                        }
                                        else {
                                            /* put */ ((m, k, v) => { if (m.entries == null)
                                                ...
                                                if (m.entries[i].key == null && k == null || m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                                                    m.entries[i].value = v;
                                                    return;
                                                } m.entries.push({ key: k, value: v, getKey: function () { return this.key; }, getValue: function () { return this.value; } }); })(hash, attribute, value);
                                        }
                                    }
                                }
                                if ( /* containsKey */((m, k) => { if (m.entries == null)
                                    ...
                                    if (existing != null && (existing instanceof Array)) {
                                        ...
                                        /* put */ ((m, k, v) => { if (m.entries == null)
                                            ...
                                            if (m.entries[i].key == null && k == null || m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                                                m.entries[i].value = v;
                                                return;
                                            } m.entries.push({ key: k, value: v, getKey: function () { return this.key; }, getValue: function () { return this.value; } }); })(structure, record.id, values);
                                    }
                                }
                                else /* put */
                                    ((m, k, v) => { if (m.entries == null)
                                        ...
                                        if (m.entries[i].key == null && k == null || m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                                            m.entries[i].value = v;
                                            return;
                                        } m.entries.push({ key: k, value: v, getKey: function () { return this.key; }, getValue: function () { return this.value; } }); })(structure, record.id, hash);
                            }
                        }
                        return bundle;
                    }
