            ...
            (function (json_1) {
                ...
                class ProvDocumentDeserializer {
                        ...
                        if (prefixes != null) {
                            {
                                ...
                                for (let index130 = 0; index130 < array131.length; index130++) {
                                    ...
                                    {
                                        var uri = prefixes.get(prefix).toString();
                                        if (uri.startsWith("\"")) {
                    ...
                    /*private*/ decodeBundle(bundleStructure) {
                        const statements = ([]);
                        {
                            ...
                            for (let index132 = 0; index132 < array133.length; index132++) {
                                ...
                                //if (statementType!=ProvDocumentDeserializer.PROV_JSON_PREFIX) //LUC
                                {
                    ...
                    /*private*/ decodeStatement(statementType, idStr, attributeMap) {
                        ...
                        switch ((provStatement)) {
                            ...
                            case org.openprovenance.prov.json.ProvJSONStatement.wasAssociatedWith:
                                var activity = this.optionalQualifiedName("prov:activity", attributeMap);
                                var agent = this.optionalQualifiedName("prov:agent", attributeMap);
                            ...
                            case org.openprovenance.prov.json.ProvJSONStatement.wasEndedBy:
                                activity = this.optionalQualifiedName("prov:activity", attributeMap);
                                var trigger = this.optionalQualifiedName("prov:trigger", attributeMap);
                                const ender = this.optionalQualifiedName("prov:ender", attributeMap);
                                var time = this.optionalTime("prov:time", attributeMap);
                            ...
                            case org.openprovenance.prov.json.ProvJSONStatement.wasGeneratedBy:
                                var entity = this.optionalQualifiedName("prov:entity", attributeMap);
                                var activity = this.optionalQualifiedName("prov:activity", attributeMap);
                                var time = this.optionalTime("prov:time", attributeMap);
                            ...
                            case org.openprovenance.prov.json.ProvJSONStatement.wasInfluencedBy:
                                var influencee = this.anyRef("prov:influencee", attributeMap);
                                var influencer = this.anyRef("prov:influencer", attributeMap);
                            ...
                            case org.openprovenance.prov.json.ProvJSONStatement.hadMember:
                                var collection = this.optionalQualifiedName("prov:collection", attributeMap);
                                var entities = this.optionalQualifiedNames("prov:entity", attributeMap);
                            ...
                            case org.openprovenance.prov.json.ProvJSONStatement.mentionOf:
                                var specificEntity = this.optionalQualifiedName("prov:specificEntity", attributeMap);
                                var generalEntity = this.optionalQualifiedName("prov:generalEntity", attributeMap);
                            ...
                            case org.openprovenance.prov.json.ProvJSONStatement.wasStartedBy:
                                ...
                                var starter = this.optionalQualifiedName("prov:starter", attributeMap);
                                time = this.optionalTime("prov:time", attributeMap);
                            ...
                            case org.openprovenance.prov.json.ProvJSONStatement.used:
                                var activity2 = this.optionalQualifiedName("prov:activity", attributeMap);
                                var entity2 = this.optionalQualifiedName("prov:entity", attributeMap);
                                time = this.optionalTime("prov:time", attributeMap);
                                var wUB = this.pf.newUsed$org_openprovenance_prov_model_QualifiedName(id);
                    ...
                    /*private*/ popMultiValAttribute(attributeName, attributeMap) {
                        //if (attributeMap.o[attributeMap]) {
                    ...
                    /*private*/ getObjectAndRemove(jsonObject, memberName) {
                        //return jsonObject.getAsJsonObject$java_lang_String(memberName);  // LUC
