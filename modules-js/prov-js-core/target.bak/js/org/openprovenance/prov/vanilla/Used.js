...
(function (org) {
    ...
    (function (openprovenance) {
        ...
        (function (prov) {
            ...
            (function (vanilla) {
                class Used {
                    constructor(id, activity, entity, time, attributes) {
                    ...
                    equals$java_lang_Object$org_openprovenance_apache_commons_lang_builder_EqualsBuilder(object, equalsBuilder) {
                        if (!(object != null && object instanceof org.openprovenance.prov.vanilla.Used)) {
                    ...
                    getAttributes() {
                        const result = ([]);
                        /* addAll */ ((l1, l2) => l1.push.apply(l1, l2))(result, this.getLabel().stream().map((s) => new org.openprovenance.prov.vanilla.Label(this.QUALIFIED_NAME_XSD_STRING, s)).collect(java.util.stream.Collectors.toList()));
                    ...
                    setIndexedAttributes(qn, attributes) {
                        const values = ([]);
                        this.u.distribute(qn, attributes, this.getLabel(), values, this.getLocation(), this.getType(), this.getRole(), this.getOther());
                    }
                    /**
                     *
                     * @return {*}
