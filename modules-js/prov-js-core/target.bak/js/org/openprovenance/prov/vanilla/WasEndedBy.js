...
(function (org) {
    ...
    (function (openprovenance) {
        ...
        (function (prov) {
            ...
            (function (vanilla) {
                class WasEndedBy {
                    constructor(id, activity, trigger, ender, time, attributes) {
                    ...
                    static u_$LI$() { if (WasEndedBy.u == null) {
                        WasEndedBy.u = new org.openprovenance.prov.vanilla.ProvUtilities();
                    } return WasEndedBy.u; }
                    /**
                     *
                     * @param {*} aid
                    ...
                    equals$java_lang_Object$org_openprovenance_apache_commons_lang_builder_EqualsBuilder(object, equalsBuilder) {
                        if (!(object != null && object instanceof org.openprovenance.prov.vanilla.WasEndedBy)) {
                    ...
                    setIndexedAttributes(qn, attributes) {
                        const values = ([]);
                        WasEndedBy.u_$LI$().distribute(qn, attributes, this.getLabel(), values, this.getLocation(), this.getType(), this.getRole(), this.getOther());
                    }
                    /**
                     *
                     * @return {*}
