...
namespace org.openprovenance.prov.model {
     ...
     * @class
     */
    export interface WasInfluencedBy extends org.openprovenance.prov.model.Identifiable, org.openprovenance.prov.model.HasLabel, org.openprovenance.prov.model.HasType, org.openprovenance.prov.model.HasOther, org.openprovenance.prov.model.Influence {
        setInfluencee(influencee: org.openprovenance.prov.model.QualifiedName);

        setInfluencer(influencer: org.openprovenance.prov.model.QualifiedName);

        getInfluencee(): org.openprovenance.prov.model.QualifiedName;

        getInfluencer(): org.openprovenance.prov.model.QualifiedName;
    }
}
