...
public class IndexedDocumentTest extends TestCase {
    ...
    public static final String TIME1 = "2012-03-11T12:00:00.000Z";
    public static final String TIME2 = "20212-03-15T12:00:30.000Z";
    ...
    public void testDoc704() {
        ...
        assertNotNull("activity", u2.getActivity());
    }
    ...
    public Document makeTimeDoc100() {
        Activity a1=pFactory.newActivity(q("a1"));
        Document doc=pFactory.newDocument();
        Activity a2=pFactory.newActivity(q("a1"));
        a2.setStartTime(pFactory.newISOTime(TIME1));
        doc.getStatementOrBundle().add(a1);
        doc.getStatementOrBundle().add(a2); // a2 is after a1
        Namespace nss=Namespace.gatherNamespaces(doc);
        doc.setNamespace(nss);
        return doc;
    }
    ...
    public void testTimeDoc100() {
        Document idoc100=new IndexedDocument(pFactory,makeTimeDoc100()).toDocument();
        assertEquals(idoc100.getStatementOrBundle().size(),1);
        assert(idoc100.getStatementOrBundle().get(0) instanceof Activity);
        Activity a=(Activity) idoc100.getStatementOrBundle().get(0);
        assertNotNull("null start time", a.getStartTime());
        assertEquals(a.getStartTime().toString(),TIME1);
    }

    public Document makeTimeDoc101() {
        Activity a1=pFactory.newActivity(q("a1"));
        Document doc=pFactory.newDocument();
        Activity a2=pFactory.newActivity(q("a1"));
        a2.setStartTime(pFactory.newISOTime(TIME1));
        doc.getStatementOrBundle().add(a2);
        doc.getStatementOrBundle().add(a1); // a1 is after a2
        Namespace nss=Namespace.gatherNamespaces(doc);
        doc.setNamespace(nss);
        return doc;
    }
    ...
    public void testTimeDoc101() {
        Document idoc101=new IndexedDocument(pFactory,makeTimeDoc101()).toDocument();
        assertEquals(idoc101.getStatementOrBundle().size(),1);
        assert(idoc101.getStatementOrBundle().get(0) instanceof Activity);
        Activity a=(Activity) idoc101.getStatementOrBundle().get(0);
        assertNotNull("null start time",a.getStartTime());
        assertEquals(a.getStartTime().toString(),TIME1);
    }


    public Document makeTimeDoc102() {
        Activity a1=pFactory.newActivity(q("a1"));
        Document doc=pFactory.newDocument();
        Activity a2=pFactory.newActivity(q("a1"));
        a2.setEndTime(pFactory.newISOTime(TIME1));
        doc.getStatementOrBundle().add(a1);
        doc.getStatementOrBundle().add(a2); // a2 is after a1
        Namespace nss=Namespace.gatherNamespaces(doc);
        doc.setNamespace(nss);
    ...
    public void testTimeDoc102() {
        Document idoc102=new IndexedDocument(pFactory,makeTimeDoc102()).toDocument();
        assertEquals(idoc102.getStatementOrBundle().size(),1);
        assert(idoc102.getStatementOrBundle().get(0) instanceof Activity);
        Activity a=(Activity) idoc102.getStatementOrBundle().get(0);
        assertNotNull("null end time", a.getEndTime());
        assertEquals(a.getEndTime().toString(),TIME1);
    }

    public Document makeTimeDoc103() {
        Activity a1=pFactory.newActivity(q("a1"));
        Document doc=pFactory.newDocument();
        Activity a2=pFactory.newActivity(q("a1"));
        a2.setEndTime(pFactory.newISOTime(TIME1));
    ...
    public void testTimeDoc103() {
        Document idoc103=new IndexedDocument(pFactory,makeTimeDoc103()).toDocument();
        assertEquals(idoc103.getStatementOrBundle().size(),1);
        assert(idoc103.getStatementOrBundle().get(0) instanceof Activity);
        Activity a=(Activity) idoc103.getStatementOrBundle().get(0);
        assertNotNull("null end time", a.getEndTime());
        assertEquals(a.getEndTime().toString(),TIME1);
    }


    public Document makeValueDoc200() {
        Entity e1=pFactory.newEntity(q("e1"));
        Document doc=pFactory.newDocument();
        Entity e2=pFactory.newEntity(q("e1"));
        e2.setValue(pFactory.newValue(MY_VALUE));
        doc.getStatementOrBundle().add(e2);
        doc.getStatementOrBundle().add(e1); // e1 is after e2
        Namespace nss=Namespace.gatherNamespaces(doc);
        doc.setNamespace(nss);
        return doc;
    }
    ...
    public void testValueDoc200() {
        Document idoc200=new IndexedDocument(pFactory,makeValueDoc200()).toDocument();
        assertEquals(idoc200.getStatementOrBundle().size(),1);
        assert(idoc200.getStatementOrBundle().get(0) instanceof Entity);
        Entity a=(Entity) idoc200.getStatementOrBundle().get(0);
        assertNotNull("null value", a.getValue());
        assertEquals(a.getValue().getValue(),MY_VALUE);
    }

    public Document makeValueDoc201() {
        Entity e1=pFactory.newEntity(q("e1"));
        Document doc=pFactory.newDocument();
        Entity e2=pFactory.newEntity(q("e1"));
        e2.setValue(pFactory.newValue(MY_VALUE));
        doc.getStatementOrBundle().add(e1); // e1 is before e2
        doc.getStatementOrBundle().add(e2);
        Namespace nss=Namespace.gatherNamespaces(doc);
        doc.setNamespace(nss);
        return doc;
    ...
    public void testValueDoc201() {
        Document idoc201=new IndexedDocument(pFactory,makeValueDoc201()).toDocument();
        assertEquals(idoc201.getStatementOrBundle().size(),1);
        assert(idoc201.getStatementOrBundle().get(0) instanceof Entity);
        Entity a=(Entity) idoc201.getStatementOrBundle().get(0);
        assertNotNull("null value", a.getValue());
        assertEquals(a.getValue().getValue(),MY_VALUE);
    }
