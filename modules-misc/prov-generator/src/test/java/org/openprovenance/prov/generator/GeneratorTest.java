...
public class GeneratorTest extends TestCase {
    ...
    public void testGenerator1() {
    	...
    	new Utility().writeDocument(doc, "target/graph50-4.provn", pf);     
    }
    ...
    public void testGenerator2() {
    	...
    	new Utility().writeDocument(doc1, "target/graph50-4-seed1.provn", pf);
    	Namespace.withThreadNamespace(doc2.getNamespace());
    	new Utility().writeDocument(doc2, "target/graph50-4-seed2.provn", pf);
