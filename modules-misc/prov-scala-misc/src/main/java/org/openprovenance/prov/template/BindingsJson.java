...
public class BindingsJson {
	...
	public static Bindings fromBean(BindingsBean bean, ProvFactory pf) {
	    return fromBeanElements(bean.var, bean.vargen, bean.context,pf);
	}

        public static Bindings fromBeanElements(Hashtable<String, List<Object>> var,
						Hashtable<String, List<Object>> vargen,
						Hashtable<String, String> context,
						ProvFactory pf) {    
        Bindings result=new Bindings(pf);
        Namespace ns=new Namespace(context);

        for (Entry<String,List<Object>> bindings: var.entrySet()) {
            ...
            for (Object value: bindings.getValue()) {
                ...
                for (Object o: wrapped) {
                    Object[] conversion=convertBeanToValue(o,context, ns, pf);
            ...
            QualifiedName myvar=pf.newQualifiedName(ExpandUtil.VAR_NS,key,"var");
