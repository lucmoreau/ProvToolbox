...
public class SummaryDocumentResourceInMemory extends DocumentResourceInMemory implements SummaryDocumentResource, Cloneable {
    ...
    public SummaryDocumentResourceInMemory(DocumentResource d) {
