...
public class CompilerExpansionBuilder {
    ...
    public JavaFile generateBuilderSpecification(Document doc, String name, String templateName, String packge, String resource, JsonNode bindings_schema) {
        ...
        return generateBuilderSpecification_aux(doc, new ArrayList<>(allVars), new ArrayList<>(allAtts), name, templateName, packge, resource, bindings_schema);
    ...
    JavaFile generateBuilderSpecification_aux(Document doc, Collection<QualifiedName> allVars, Collection<QualifiedName> allAtts, String name, String templateName, String packge, String resource, JsonNode bindings_schema) {
        ...
        builder.addMethod(generateTypePropagator(allVars, allAtts, doc, vmap, packge+".client", bindings_schema));
    ...
    public MethodSpec generateTypePropagator(Collection<QualifiedName> allVars, Collection<QualifiedName> allAtts, Document doc, Hashtable<QualifiedName, String> vmap, String packge, JsonNode bindings_schema) {
        ...
        while (iter.hasNext()) {
            ...
            if (compilerUtil.isVariableDenotingQualifiedName(key,the_var)) {
                if ((successors.get(key)!=null)  || (successors2.get(key)!=null)) {
                    ...
                    builder.addStatement("propagateTypes_n(record,mapLevelN,mapLevelNP1,$L)", count);
                }
            }
            count++;
        }
    ...
    public MethodSpec generateTypePropagatorN() {
        ...
        String tmpVar="tmp";
        //builder.addStatement("System.out.println(\"$N[\" + $L + \"] \" + $N[$L])", "record", "count", "record", "count");
        //builder.addStatement("System.err.println(\"$N[\" + $L + \"] \" + $N[$L])", "record", "count", "record", "count");
