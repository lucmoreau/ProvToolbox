...
import static org.openprovenance.prov.template.compiler.ConfigProcessor.typeOutput;
...
public class CompilerIntegrator {
    ...
    public MethodSpec generateNewOutputConstructor(String templateName, String packge, TemplateBindingsSchema bindingsSchema, BeanKind outputs) {
        ...
        if (debugComment) builder.addComment("Generated by method $N", getClass().getName()+".generateNewOutputConstructor()");
