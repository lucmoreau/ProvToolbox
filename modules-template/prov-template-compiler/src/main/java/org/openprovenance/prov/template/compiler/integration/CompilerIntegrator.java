        ...
        if (beanKind==BeanKind.SIMPLE) {
            ...
            if (variants!=null) {
                variants.keySet().forEach(variant -> {
                    ...
                    builder.addMethod(compilerCommon.generateFactoryMethodToBeanWithArray_old(locations, TO_INPUTS+extension, consistsOf, integrator_package, tbs, INPUTS, extension, shared));
