...
public class CompilerBeanCompleter2Old {
    private final CompilerUtil compilerUtil;
    private final boolean debugComment=true;

    public static final TypeName mapType=ParameterizedTypeName.get(ClassName.get(Map.class),ClassName.get(String.class),ClassName.get(Object.class));
    public static final TypeName classType=ParameterizedTypeName.get(ClassName.get(Class.class), typeT);

    public CompilerBeanCompleter2Old(ProvFactory pFactory) {
        this.compilerUtil=new CompilerUtil(pFactory);
    }


    public SpecificationFile generateBeanCompleter2(TemplatesProjectConfiguration configs, Locations locations, String fileName) {
        ...
        builder.addField(ClassName.get(" org.openprovenance.prov.client", Constants.GETTER),"getter", Modifier.FINAL, Modifier.PROTECTED);
        ...
        cbuilder2.addStatement("this.getter = $L",
                TypeSpec.anonymousClassBuilder("")
                 //       .addSuperinterface(TypeVariableName.get(Constants.GETTER))
                        .addSuperinterface(ClassName.get(" org.openprovenance.prov.client",Constants.GETTER))
        ...
        cbuilder3
                .addModifiers(Modifier.PUBLIC)
                .addParameter(ClassName.get(" org.openprovenance.prov.client",Constants.GETTER), "getter")
