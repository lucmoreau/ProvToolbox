...
import static org.openprovenance.prov.template.compiler.CompilerCatalogueDispatcher.poetSupplierOfString;
import static org.openprovenance.prov.template.compiler.ConfigProcessor.*;

public class CompilerBeanEnactor2CompositeWithPrincipalOld {
    ...
    public CompilerBeanEnactor2CompositeWithPrincipalOld(ProvFactory pFactory) {
        this.compilerUtil=new CompilerUtil(pFactory);
    }


    public SpecificationFile generateBeanEnactor2CompositeWithPrincipal(TemplatesProjectConfiguration configs, Locations locations, String fileName) {
        ...
        builder.addField(poetSupplierOfString, PRINCIPAL_MANAGER_VAR, Modifier.FINAL, Modifier.PRIVATE);
        ...
        MethodSpec.Builder cbuilder3= MethodSpec.constructorBuilder()
                ...
                .addParameter(poetSupplierOfString, PRINCIPAL_MANAGER_VAR);
