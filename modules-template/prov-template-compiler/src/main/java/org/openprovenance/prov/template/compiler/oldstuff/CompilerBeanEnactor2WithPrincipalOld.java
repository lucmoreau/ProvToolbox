...
import static org.openprovenance.prov.template.compiler.oldstuff.CompilerBeanEnactor2CompositeWithPrincipalOld.BIFUN;

public class CompilerBeanEnactor2WithPrincipalOld {
    ...
    public CompilerBeanEnactor2WithPrincipalOld(ProvFactory pFactory) {
