...
public class CompilerCatalogueDispatcherOld {
    ...
    static final ParameterizedTypeName FunctionStringResultSet = ParameterizedTypeName.get(ClassName.get(Function.class), ClassName.get(String.class), ClassName.get(java.sql.ResultSet.class));
    ...
    static final ParameterizedTypeName FunctionObjArray2ObjArray= ParameterizedTypeName.get(ClassName.get(Function.class), ArrayTypeName.of(ClassName.get(Object.class)), ArrayTypeName.of(ClassName.get(Object.class)));
   // Supplier<String>
    ...
    public static Map<String,String> dataConfiguratorMap=new HashMap<>() {{
    ...
    public static Map<String,TypeName> dataTypeMap=new HashMap<>() {{
    ...
    public CompilerCatalogueDispatcherOld(ProvFactory pFactory) {
