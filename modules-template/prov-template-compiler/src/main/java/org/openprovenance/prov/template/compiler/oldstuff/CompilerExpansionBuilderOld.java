...
import static org.openprovenance.prov.template.core.InstantiateUtil.ACTIVITY_TYPE_URI;
import static org.openprovenance.prov.template.core.InstantiateUtil.TMPL_ACTIVITY_URI;

public class CompilerExpansionBuilderOld {
    ...
    public CompilerExpansionBuilderOld(boolean withMain, CompilerCommon compilerCommon, ProvFactory pFactory, boolean debugComment, CompilerTypeManagement compilerTypeManagement) {
    ...
    SpecificationFile generateBuilderSpecification_aux(TemplatesProjectConfiguration configs, Locations locations, Document doc, Collection<QualifiedName> allVars, Collection<QualifiedName> allAtts, String name, String templateName, String templateFullyQualifiedName, String packge, TemplateBindingsSchema bindingsSchema, Map<Integer, List<Integer>> successorTable, String directory, String fileName) {
        ...
        builder.addMethod(compilerUtil.generateConstructor2_old(vmap));
