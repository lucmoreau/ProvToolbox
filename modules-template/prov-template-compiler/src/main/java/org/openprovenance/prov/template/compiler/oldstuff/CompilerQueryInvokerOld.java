...
public class CompilerQueryInvokerOld {
    ...
    private final CompilerQueryInvoker newCompilerQueryInvoker;


    public CompilerQueryInvokerOld(ProvFactory pFactory) {
        this.compilerUtil=new CompilerUtil(pFactory);
        this.newCompilerQueryInvoker=new CompilerQueryInvoker(pFactory);
    }
    ...
    public SpecificationFile generateQueryInvoker(TemplatesProjectConfiguration configs, Locations locations, boolean withBean, String fileName) {
        //return newCompilerQueryInvoker.generateQueryInvoker(configs, locations, withBean, fileName);
        return generateQueryInvoker_old(configs, locations, withBean, fileName);
    }

    public SpecificationFile generateQueryInvoker_old(TemplatesProjectConfiguration configs, Locations locations, boolean withBean, String fileName) {
