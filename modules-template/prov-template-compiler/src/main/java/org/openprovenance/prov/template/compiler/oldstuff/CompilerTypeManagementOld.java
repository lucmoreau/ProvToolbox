...
public class CompilerTypeManagementOld {
    ...
    public CompilerTypeManagementOld(boolean withMain, CompilerCommon compilerCommon, ProvFactory pFactory, boolean debugComment) {
    ...
    public SpecificationFile generateTypeDeclaration_aux(TemplatesProjectConfiguration configs, Locations locations, Document doc, Set<QualifiedName> allVars, Set<QualifiedName> allAtts, String name, String templateName, String packge, TemplateBindingsSchema bindingsSchema, String directory, String fileName) {
        ...
        StatementTypeActionOld action = new StatementTypeActionOld(pFactory, allVars, allAtts, null, null, "__C_document.getStatementOrBundle()", bindingsSchema, knownTypes, unknownTypes, mbuilder,compilerUtil);
