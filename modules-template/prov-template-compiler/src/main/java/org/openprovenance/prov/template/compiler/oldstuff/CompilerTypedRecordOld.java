...
public class CompilerTypedRecordOld {
    ...
    public CompilerTypedRecordOld(boolean withMain, CompilerCommon compilerCommon, ProvFactory pFactory, boolean debugComment) {
