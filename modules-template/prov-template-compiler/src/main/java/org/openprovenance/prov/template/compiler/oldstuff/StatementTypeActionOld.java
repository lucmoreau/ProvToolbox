...
public class StatementTypeActionOld implements StatementAction {
    ...
    public StatementTypeActionOld(ProvFactory pFactory, Set<QualifiedName> allVars, Set<QualifiedName> allAtts, Hashtable<QualifiedName, String> vmap, Builder builder, String target, TemplateBindingsSchema bindingsSchema, Map<String, Collection<String>> knownTypes, Map<String, Collection<String>> unknownTypes, Builder mbuilder, CompilerUtil compilerUtil) {
...
// LUC use each tyep here
    ...
    public void doAction(Bundle bun, ProvUtilities provUtilities) {
        ...
        StatementTypeActionOld action2=new StatementTypeActionOld(pFactory, allVars, allAtts, vmap, null, null, bindingsSchema, knownTypes, unknownTypes, mbuilder, compilerUtil);
