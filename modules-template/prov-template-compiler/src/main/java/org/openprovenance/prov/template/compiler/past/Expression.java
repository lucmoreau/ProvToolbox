...
public abstract class Expression extends Statement {
    public enum ExpressionKind {VALUE, VARIABLE, METHOD_CALL,CLASS_INSTANTIATION, PARAMETER_REFERENCE, CONSTANT, CAST, ARRAY_INITIALISER, LAMBDA_EXPRESSION, ARRAY_ACCESSOR, POST_INCREMENT, IF_EXPRESSION, ARRAY_ALLOCATOR, INSTANCEOF, BINARY_OP    }
