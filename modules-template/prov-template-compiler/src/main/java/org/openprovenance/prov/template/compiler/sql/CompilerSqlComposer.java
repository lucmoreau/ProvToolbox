...
public class CompilerSqlComposer {
    ...
    boolean generatedPrelude=false;
  ...
  /*              "\n\n" +
        ...
        QueryBuilder fun =
                new QueryBuilder()
                       // .comment(generatedPrelude? "PRELUDE ALREADY GENERATED" : PRELUDE_TO_AUTO_GENERATE)
...
$$ language SQL;         */
        ...
        for (String relation: sqlTables) {
            ...
            System.out.println("###############################  in generateInsertIntoSharedRelation EXTRAS " + extras);


            System.out.println("###############################  in generateInsertIntoSharedRelation " + sqlTables);
