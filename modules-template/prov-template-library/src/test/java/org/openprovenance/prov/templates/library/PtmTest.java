...
import static org.openprovenance.prov.template.library.ptm_copy.logger.Logger.logPtm_expanding;
...
public class PtmTest extends TestCase {
    ...
    public void testPtm1() throws JsonProcessingException {
        String res=logPtm_expanding("doc123.prov", "prov-doc123.prov-csv", "tmpl/plead-filtering.provn", "bindings/ex1223.json",
