...
// in file CompilerLogger.java, at line 28
package org.openprovenance.prov.template.library.ptm.logger;
...
import org.openprovenance.prov.template.library.ptm.client.configurator.BuilderConfigurator;
import org.openprovenance.prov.template.library.ptm.client.configurator.CompositeTableConfigurator;
import org.openprovenance.prov.template.library.ptm.client.configurator.ConverterConfigurator;
...
public class Logger implements LoggerInterface {
  ...
  public Builder[] getBuilders() {
    ...
    // in file CompilerLogger.java, at line 294
    return __builders;
  }
   ...
   */
  public static String logPtm_expanding(String document, String template, String bindings,
      Integer agent, Integer expanding, String email, String time) {
    // Generated by class org.openprovenance.prov.template.compiler.CompilerLogger, method generateStaticLogMethod
    // in file CompilerLogger.java, at line 230
    return ___ptm_expanding.args2csv().process(document, template, bindings, agent, expanding, email, time);
  }
   ...
   * @return not documented.
   */
  public static Ptm_expandingBean beanPtm_expanding(String document, String template,
      String bindings, Integer agent, Integer expanding, String email, String time) {
    return ___ptm_expanding.aArgs2BeanConverter.process(document, template, bindings, agent, expanding, email, time);
  }
   ...
   * @return not documented.
   */
  public static String logPtm_mexpanding(String template, String mtemplate, String bindings,
      Integer agent, Integer mexpanding, String email, String time) {
    // Generated by class org.openprovenance.prov.template.compiler.CompilerLogger, method generateStaticLogMethod
    // in file CompilerLogger.java, at line 230
    return ___ptm_mexpanding.args2csv().process(template, mtemplate, bindings, agent, mexpanding, email, time);
  }
   ...
   * @return not documented.
   */
  public static Ptm_mexpandingBean beanPtm_mexpanding(String template, String mtemplate,
      String bindings, Integer agent, Integer mexpanding, String email, String time) {
    return ___ptm_mexpanding.aArgs2BeanConverter.process(template, mtemplate, bindings, agent, mexpanding, email, time);
  }
  ...
  public static <T> Map<String, T> initializeBeanTable(TableConfigurator<T> configurator) {
    ...
    // in file CompilerLogger.java, at line 106
  ...
  public static <T> Map<String, T> initializeCompositeBeanTable(
    ...
    // in file CompilerLogger.java, at line 133
    Map<String, T> aTable=new HashMap<String, T>();
    return aTable;
  }
}
