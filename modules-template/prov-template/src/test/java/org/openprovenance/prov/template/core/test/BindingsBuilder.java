...
public class BindingsBuilder {
    ...
    public BindingsBuilder(ProvFactory pf) {
        this.pf = pf;
        this.var_a = this.pf.newQualifiedName(InstantiateUtil.VAR_NS, "a", "var");
        this.var_b = this.pf.newQualifiedName(InstantiateUtil.VAR_NS, "b", "var");
        this.var_c = this.pf.newQualifiedName(InstantiateUtil.VAR_NS, "c", "var");
        this.var_d = this.pf.newQualifiedName(InstantiateUtil.VAR_NS, "d", "var");
        this.var_e = this.pf.newQualifiedName(InstantiateUtil.VAR_NS, "e", "var");
        this.var_e2 = this.pf.newQualifiedName(InstantiateUtil.VAR_NS, "e2", "var");
        this.var_ag = this.pf.newQualifiedName(InstantiateUtil.VAR_NS, "ag", "var");
        this.var_pl = this.pf.newQualifiedName(InstantiateUtil.VAR_NS, "pl", "var");
        this.var_label = this.pf.newQualifiedName(InstantiateUtil.VAR_NS, "label", "var");
        this.var_start = this.pf.newQualifiedName(InstantiateUtil.VAR_NS, "start", "var");
        this.var_end = this.pf.newQualifiedName(InstantiateUtil.VAR_NS, "end", "var");
    }
    ...
    OldBindings makeBindings20() {
        ...
        ll.add(pf.newOther(pf.newQualifiedName(InstantiateUtil.TMPL_NS, "ignore", "app"), "me1@example", pf.getName().XSD_STRING));
        bindings1.addAttribute(var_d, ll);

        ll = new LinkedList<>();
        ll.add(pf.newOther(pf.newQualifiedName(InstantiateUtil.TMPL_NS, "ignore", "app"), "m22@example", pf.getName().XSD_STRING));
        bindings1.addAttribute(var_d, ll);

        ll = new LinkedList<>();
        ll.add(pf.newOther(pf.newQualifiedName(InstantiateUtil.TMPL_NS, "ignore", "app"), "Luc1@example", pf.getName().XSD_STRING));
        bindings1.addAttribute(var_e, ll);

        ll = new LinkedList<>();
        ll.add(pf.newOther(pf.newQualifiedName(InstantiateUtil.TMPL_NS, "ignore", "app"), "Luc2@example", pf.getName().XSD_STRING));
        bindings1.addAttribute(var_e, ll);

        ll = new LinkedList<>();
        ll.add(pf.newOther(pf.newQualifiedName(InstantiateUtil.TMPL_NS, "ignore", "app"), "Luc3@example", pf.getName().XSD_STRING));
        bindings1.addAttribute(var_e, ll);

        ll = new LinkedList<>();
        ll.add(pf.newOther(pf.newQualifiedName(InstantiateUtil.TMPL_NS, "ignore", "app"), "Luc4@example", pf.getName().XSD_STRING));
        bindings1.addAttribute(var_e, ll);

        ll = new LinkedList<>();
        ll.add(pf.newOther(pf.newQualifiedName(InstantiateUtil.TMPL_NS, "ignore", "app"), "Luc5@example", pf.getName().XSD_STRING));
        bindings1.addAttribute(var_e, ll);

        ll = new LinkedList<>();
        ll.add(pf.newOther(pf.newQualifiedName(InstantiateUtil.TMPL_NS, "ignore", "app"), "Luc6@example", pf.getName().XSD_STRING));
        ll.add(pf.newOther(pf.newQualifiedName(InstantiateUtil.TMPL_NS, "ignore", "app"), "Luc7@example", pf.getName().XSD_STRING));
        bindings1.addAttribute(var_e, ll);
        return bindings1;
    }
    ...
    OldBindings makeBindings21() {
        ...
        ll = new LinkedList<>();
        ll.add(pf.newOther(pf.newQualifiedName(InstantiateUtil.TMPL_NS, "ignore", "app"), "me2@example", pf.getName().XSD_STRING));
        bindings1.addAttribute(var_d, ll);


        ll = new LinkedList<>();
        ll.add(pf.newOther(pf.newQualifiedName(InstantiateUtil.TMPL_NS, "ignore", "app"), "me3@example", pf.getName().XSD_STRING));
        bindings1.addAttribute(var_d, ll);
    ...
    OldBindings makebindinsg23() {
        ...
        ll = new LinkedList<>();
        ll.add(pf.newOther(pf.newQualifiedName(InstantiateUtil.TMPL_NS, "ignore", "app"), "label1", pf.getName().XSD_STRING));
        bindings23.addAttribute(var_label, ll);

        ll = new LinkedList<>();
        ll.add(pf.newOther(pf.newQualifiedName(InstantiateUtil.TMPL_NS, "ignore", "app"), "label2", pf.getName().XSD_STRING));
        bindings23.addAttribute(var_label, ll);

        ll = new LinkedList<>();
        ll.add(pf.newOther(pf.newQualifiedName(InstantiateUtil.TMPL_NS, "ignore", "app"), "label3", pf.getName().XSD_STRING));
        ll.add(pf.newOther(pf.newQualifiedName(InstantiateUtil.TMPL_NS, "ignore", "app"), "label3b", pf.getName().XSD_STRING));
        bindings23.addAttribute(var_label, ll);
        return bindings23;
    }
