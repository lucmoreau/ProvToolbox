...
import ${package}.ValidationReportMessageBodyReader;
...
abstract public class DateIT extends TestCase implements ApiUriFragments {
    ...
    static String escapeRed(String str) {
        return "${symbol_escape}u001B[31m" + str + "${symbol_escape}u001B[0m";
    }
    static String escapeGreen(String str) {
        return "${symbol_escape}u001B[32m" + str + "${symbol_escape}u001B[0m";
    }
