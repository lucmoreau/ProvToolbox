...
abstract public class TranslateIT extends RoundTripFromJavaTest implements ApiUriFragments  {
    ...
    public boolean checkTest(String name, ProvFormat format)
    {
        ...
        if (name.endsWith("bundle4"+extension()) && format.equals(ProvFormat.PROVX)) {
            System.out.println(escapeRed("${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} Skipping  comparison for bundle4 and PROVX"));
            return false;
        }
        if (name.endsWith("bundle5"+extension()) &&  format.equals(ProvFormat.PROVX)) {
            System.out.println(escapeRed("${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} Skipping  comparison for bundle5 and PROVX"));
            return false;
        }
   ...
   // public void testMembership1() {} //ok in service.light
    ...
    public void addFurtherAttributes(HasOther he) {
      ...
      //he.getOther().add(pFactory.newOther("http://example.org/", "tag1", "ex", "hello${symbol_escape}nover${symbol_escape}nmore${symbol_escape}nlines", name.XSD_STRING));
    ...
    public void testEntity101() {
        System.out.println(escapeRed("${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} Skipping testEntity101 in TranslatorIT.java"));
    }
    @Override
    public void testDefault1() {
        System.out.println(escapeRed("${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} Skipping testing for default1 in PROVX"));
        //super.testDefault1();
    }

    @Override
    public void testDictionaryMembership1() {
        System.out.println(escapeRed("${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} Skipping testDictionaryMembership1 (service)"));
    }
    @Override
    public void testDictionaryMembership2() {
        System.out.println(escapeRed("${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} Skipping testDictionaryMembership2 (service)"));
    }
    @Override public void testDictionaryMembership3() {
        System.out.println(escapeRed("${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} Skipping testDictionaryMembership3 (service)"));
    }
    @Override public void testDictionaryMembership4() {
        System.out.println(escapeRed("${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} Skipping testDictionaryMembership4 (service)"));
    }
