...
public class HasProvenanceHeaderFilter  implements Filter, Constants {
    ...
    public HasProvenanceHeaderFilter() {
        logger.info("${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} HasProvenanceHeaderFilter constructor ${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}");
    }
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (requestURI.contains("webjars/prov-template-library/")) {
            ...
            if (requestURI.contains("templates/org/openprovenance/prov/templates/")
                ...
                httpServletResponse.setHeader("Link", "<" + theProvenance + ">; rel=${symbol_escape}"" + HAS_PROVENANCE + "${symbol_escape}"");

                //Link: <http://acme.example.org/super-widget123/provenance>;
                //         rel="http://www.w3.org/ns/prov${symbol_pound}has_provenance"
