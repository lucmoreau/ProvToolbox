...
public class Storage {
    ...
    static {
        ...
        if (properties==null) {
            ...
            try {
                properties.load(new FileInputStream("/Users/luc/git-papers/papers/book-ptm/project/${artifactId}/target/classes/properties/the-template-library.webapp.config.properties"));
