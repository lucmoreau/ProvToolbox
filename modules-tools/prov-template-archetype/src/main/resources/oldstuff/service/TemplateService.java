...
public class TemplateService {
    ...
    @GET
    @Path("/template/{template}/{id}/{variable:${symbol_escape}${symbol_escape}w+}{extension:(${symbol_escape}${symbol_escape}.${symbol_escape}${symbol_escape}w+)?}")
    @Tag(name = "template")
        ...
        switch (request.getHeader(HttpHeaders.ACCEPT).toLowerCase()) {
            case MediaType.TEXT_PLAIN:
                ...
                for (String key: explanations.keySet()) {
                    sb.append(explanations.get(key)).append("${symbol_escape}n");
                }
    ...
    @GET
    @Path("/live/{relation}/{id:${symbol_escape}${symbol_escape}d+}{extension:(${symbol_escape}${symbol_escape}.${symbol_escape}${symbol_escape}w+)?}")
    @Tag(name = "template")
    @Produces({ InteropMediaType.MEDIA_APPLICATION_JSONLD, InteropMediaType.MEDIA_TEXT_PROVENANCE_NOTATION, MEDIA_IMAGE_SVG_XML })
    @Consumes({InteropMediaType.MEDIA_APPLICATION_JSON})
