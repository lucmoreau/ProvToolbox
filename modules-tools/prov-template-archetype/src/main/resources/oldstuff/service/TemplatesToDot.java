...
public class TemplatesToDot extends ProvToDot {
    ...
    public static String createHtmlTable(TemplateInfo templateInfo,
        ...
        html.append("<TABLE BORDER=${symbol_escape}"0${symbol_escape}" CELLBORDER=${symbol_escape}"1${symbol_escape}" CELLSPACING=${symbol_escape}"0${symbol_escape}" CELLPADDING=${symbol_escape}"4${symbol_escape}">${symbol_escape}n");

        // First row with rowspan and input cells
        html.append("  <TR>${symbol_escape}n");
        html.append(String.format("    <TD ROWSPAN=${symbol_escape}"3${symbol_escape}" HREF=${symbol_escape}"%s${symbol_escape}"  TARGET=${symbol_escape}"_blank${symbol_escape}">%s </TD>${symbol_escape}n", templateInfo.url, templateInfo.templateId));
        for (int i = 0; i < inputsNames.size(); i++) {
            html.append(String.format("    <TD PORT=${symbol_escape}"%s${symbol_escape}" BGCOLOR=${symbol_escape}"%s${symbol_escape}" HREF=${symbol_escape}"%s${symbol_escape}" TARGET=${symbol_escape}"_blank${symbol_escape}">%s</TD>${symbol_escape}n",
   ...
   final Map<String, String> provcolors = new HashMap<>() {{
        put("http://www.w3.org/ns/prov${symbol_pound}Entity", ENTITY_FILLCOLOUR);
        put("http://www.w3.org/ns/prov${symbol_pound}Activity", ACTIVITY_FILL_COLOUR);
        put("http://www.w3.org/ns/prov${symbol_pound}Agent", AGENT_FILLCOLOUR);
    }};
    ...
    private void emitEdge(String source, String destination, PrintStream out) {
        ...
        sb.append("[dir=${symbol_escape}"both${symbol_escape}", arrowhead=${symbol_escape}"").append(headstyle).append("${symbol_escape}", arrowtail=${symbol_escape}"").append(tailstyle).append("${symbol_escape}"]");
        sb.append(";${symbol_escape}n");
    ...
    public void emitTemplate(String template, String templateId, String htmlTable, PrintStream out) {
        StringBuffer sb=new StringBuffer();
        sb.append("${symbol_escape}n");
        sb.append("node [shape=plaintext]${symbol_escape}n");
