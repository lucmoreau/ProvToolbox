...
public class ModelConstructor implements org.openprovenance.prov.model.ModelConstructor {
    ...
    public Activity newActivity(QualifiedName id, XMLGregorianCalendar startTime, XMLGregorianCalendar endTime, Collection<Attribute> attributes) {
        return new org.openprovenance.prov.core.vanilla.Activity(id,startTime,endTime,attributes);
    }

    @Override
    public Agent newAgent(QualifiedName id, Collection<Attribute> attributes) {
        return new org.openprovenance.prov.core.vanilla.Agent(id,attributes);
    }
    ...
    public Entity newEntity(QualifiedName id, Collection<Attribute> attributes) {
        return new org.openprovenance.prov.core.vanilla.Entity(id,attributes);
    }
    ...
    public HadMember newHadMember(QualifiedName c, Collection<QualifiedName> e) {
        ...
        ll.addAll(e);
        return new org.openprovenance.prov.core.vanilla.HadMember(c,ll);
    }
    ...
    public QualifiedName newQualifiedName(String namespace, String local, String prefix) {
        return new org.openprovenance.prov.core.vanilla.QualifiedName(namespace,local,prefix);
    }
    ...
    public SpecializationOf newSpecializationOf(QualifiedName e2, QualifiedName e1) {
        return new org.openprovenance.prov.core.vanilla.SpecializationOf(e2,e1);
    }
