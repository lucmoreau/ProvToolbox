...
@SuppressWarnings("unchecked")
@Deprecated
class OldJSONConstructor implements OldTreeConstructor {
	static Logger logger = Logger.getLogger(OldJSONConstructor.class);
	...
	public static void main(String[] args)  {
        try {
            ...
            Object provStructure = new OldTreeTraversal(new OldJSONConstructor()).convert(tree);
