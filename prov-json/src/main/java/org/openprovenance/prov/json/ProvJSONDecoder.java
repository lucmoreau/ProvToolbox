...
//	private static final String PROV_JSON_REVISION =            "wasRevisionOf";
//	private static final String PROV_JSON_QUOTATION =           "wasQuotedFrom";
//	private static final String PROV_JSON_PRIMARY_SOURCE =      "hadPrimarySource";
...
//		map.put(PROV_JSON_REVISION, ProvStatement.REVISION);
//		map.put(PROV_JSON_QUOTATION, ProvStatement.QUOTATION);
//		map.put(PROV_JSON_PRIMARY_SOURCE, ProvStatement.PRIMARY_SOURCE);
...
//		case PRIMARY_SOURCE:
			...
			case DERIVATION:
				...
				break;
//			case REVISION:
//				WasRevisionOf wRO = pf.newWasRevisionOf(id, generatedEntity, usedEntity);
//				if (activity != null) wRO.setActivity(activity);
//				if (generatedEntity != null) wRO.setGeneration(generation);
//				if (usage != null) wRO.setUsage(usage);
//				statement = wRO;
//				break;
//			case QUOTATION:
//				WasQuotedFrom wQF = pf.newWasQuotedFrom(id, generatedEntity, usedEntity);
//				if (activity != null) wQF.setActivity(activity);
//				if (generatedEntity != null) wQF.setGeneration(generation);
//				if (usage != null) wQF.setUsage(usage);
//				statement = wQF;
//				break;
//			case PRIMARY_SOURCE:
//				HadPrimarySource hPS = pf.newHadPrimarySource(id, generatedEntity, usedEntity);
//				if (activity != null) hPS.setActivity(activity);
//				if (generatedEntity != null) hPS.setGeneration(generation);
//				if (usage != null) hPS.setUsage(usage);
//				statement = hPS;
//				break;
			}
			break;
