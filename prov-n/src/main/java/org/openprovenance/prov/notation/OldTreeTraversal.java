...
public class OldTreeTraversal {

    private OldTreeConstructor c;
    public OldTreeTraversal(OldTreeConstructor c) {
        this.c=c;
    }
...
*/
        ...
        case PROV_NParser.DBRF:
            ...
            Object keylist=c.convertKeys((List<Object>)keyset);
            dAttrs=convert(ast.getChild(4));
        ...
        case PROV_NParser.DOCUMENT:
	        ...
	        @SuppressWarnings("unchecked")
                List<Object> tmp = (List<Object>)convert(ast.getChild(2));
	        bundles=tmp;
            }
        ...
        case PROV_NParser.NAMESPACES:
            List<Object> namespaces=new LinkedList<Object>();
            for (int i=0; i< ast.getChildCount(); i++) {
                Object o=convert(ast.getChild(i));
                namespaces.add(o);
            }
