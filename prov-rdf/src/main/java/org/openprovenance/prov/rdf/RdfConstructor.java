...
public class RdfConstructor implements TreeConstructor {
    ...
    public void processAttributes(QName a, List<?> aAttrs) {
    	...
    	org.openrdf.model.Resource r=
    			new org.openrdf.model.impl.URIImpl(a.getNamespaceURI()+a.getLocalPart());
    	...
    	for (Object entry: aAttrs) {
    		...
    		System.out.println(" value " + typedLit[0]);
    		System.out.println(" type " + typedLit[1]);
    		
    		QName pred = getQName(pair[0]);
    		System.out.println(" pred qname " + pred);
    		
    		QName t=getQName((String)(typedLit[1]));
    		//	    System.out.println(" type for literal " + ((String)(typedLit[1])));
    		//	    System.out.println(" type for literal " + t);
    		
    		org.openrdf.model.Statement stmnt
    		=new org.openrdf.model.impl.StatementImpl(r,
    				new org.openrdf.model.impl.URIImpl(pred.getNamespaceURI()+
    						pred.getLocalPart()),
    						new org.openrdf.model.impl.LiteralImpl((String)(typedLit[0]),
    								new org.openrdf.model.impl.URIImpl(t.getNamespaceURI()+
    										t.getLocalPart())));
