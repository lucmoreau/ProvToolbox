...
public class ProvMixin extends org.openprovenance.prov.core.jsonld.serialization.ProvMixin {
    ...
    public void addProvMixin(ObjectMapper mapper) {
        mapper.addMixIn(Document.class,             org.openprovenance.prov.scala.jsonld11.Document.class);
        ...
        mapper.addMixIn(Bundle.class,               JLD_Bundle.class);
        mapper.addMixIn(SpecializationOf.class,     JLD_QualifiedSpecializationOf.class);
        mapper.addMixIn(AlternateOf.class,          JLD_QualifiedAlternateOf.class);
        mapper.addMixIn(HadMember.class,            JLD_QualifiedHadMember.class);
