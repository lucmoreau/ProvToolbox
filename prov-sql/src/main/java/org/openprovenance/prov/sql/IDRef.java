    ...
    implements Equals, HashCode, org.openprovenance.prov.model.IDRef
{
    ...
    @Basic
   @Column(name = "URI")public String getUri() { return ((this.getRef()==null)? null: this.getRef().getNamespaceURI() + this.getRef().getLocalPart()); } public void setUri(String uri) {} @Basic@Column(name = "REFITEM")
