...
public class BeanTraversal {
	...
	public Object convert(WasStartedBy o) {
		...
		ActivityRef a;
		ActivityRef s;
		return c.convertWasStartedBy(c.convert(o.getId()), tAttrs, otherAttrs,
	...
	public Object convert(WasEndedBy o) {
		...
		ActivityRef a;
		ActivityRef s;
		return c.convertWasEndedBy(c.convert(o.getId()), tAttrs, otherAttrs,
				((a = o.getActivity()) == null) ? null : c.convert(a.getRef()),
				((e = o.getTrigger()) == null) ? null : c.convert(e.getRef()),
	...
	public Object convert(WasGeneratedBy o) {
		...
		return c.convertWasGeneratedBy(c.convert(o.getId()), tAttrs,
				otherAttrs, c.convert(o.getEntity().getRef()),
				((a = o.getActivity()) == null) ? null : c.convert(a.getRef()),
				o.getTime());
	}
	...
	public Object convert(WasInfluencedBy o) {
		...
		return c.convertWasInfluencedBy(c.convert(o.getId()), tAttrs,
				otherAttrs, c.convert(o.getInfluencee().getRef()),
	...
	public Object convert(WasDerivedFrom o) {
		...
		return c.convertWasDerivedFrom(c.convert(o.getId()), tAttrs,
				otherAttrs, c.convert(o.getGeneratedEntity().getRef()),
	...
	public Object convert(WasAssociatedWith o) {
		List tAttrs = convertTypeAttributes((HasType) o);
		List otherAttrs = convertAttributes((HasExtensibility) o);
		return c.convertWasAssociatedWith(
				c.convert(o.getId()),
				tAttrs,
				otherAttrs,
				c.convert(o.getActivity().getRef()),
	...
	public Object convert(WasAttributedTo o) {
		List tAttrs = convertTypeAttributes((HasType) o);
		List otherAttrs = convertAttributes((HasExtensibility) o);
		return c.convertWasAttributedTo(
				c.convert(o.getId()),
				tAttrs,
				otherAttrs,
	...
	public Object convert(ActedOnBehalfOf o) {
		List tAttrs = convertTypeAttributes((HasType) o);
		List otherAttrs = convertAttributes((HasExtensibility) o);
		return c.convertActedOnBehalfOf(
				c.convert(o.getId()),
				tAttrs,
				otherAttrs,
				c.convert(o.getSubordinate().getRef()),
				c.convert(o.getResponsible().getRef()),
				(o.getActivity() == null) ? null : c.convert(o.getActivity()
						.getRef()));
	}
	...
	public Object convert(SpecializationOf o) {
		return c.convertSpecializationOf(
				c.convert(o.getSpecializedEntity().getRef()),
