...
public class QualifiedHadMember extends HadMember implements Equals, HashCode, ToString, org.openprovenance.prov.model.extension.QualifiedHadMember, HasAllAttributes 
{
    ...
    public void toString(ToStringBuilder toStringBuilder) {
        {
            ...
            theInformed = this.getCollection();
            toStringBuilder.append("collection", theInformed);
        }
        {
            List<org.openprovenance.prov.model.QualifiedName> theInformant;
            theInformant = this.getEntity();
            toStringBuilder.append("entity", theInformant);
        }
        {
