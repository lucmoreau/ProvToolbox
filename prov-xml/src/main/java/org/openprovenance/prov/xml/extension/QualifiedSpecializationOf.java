...
import org.openprovenance.prov.xml.IDRefAdapter;
    ...
    public void toString(ToStringBuilder toStringBuilder) {
        {
            ...
            theInformed = this.getSpecificEntity();
            toStringBuilder.append("specificEntity", theInformed);
        }
        {
            org.openprovenance.prov.model.QualifiedName theInformant;
            theInformant = this.getGeneralEntity();
            toStringBuilder.append("generalEntity", theInformant);
        }
        {
