...
public class LocationAdapter
    extends XmlAdapter<Object,Location>
{
    ...
    public Location unmarshal(Object value) {
        if (value instanceof org.w3c.dom.Element) {
            ...
            if (type.equals(ValueConverter.QNAME_XSD_QNAME)) {
                ...
                return new Location( qn, type);
            } else if ((lang==null) || (lang.equals(""))) {
		return new Location(vconv.convertToJava(type, child), type);
	    } else {
		return new Location(pFactory.newInternationalizedString(child,lang), type);
	    }
        } 
