...
/**
 * <p>Java class for Used complex type.
 * 
...
@XmlType(name = "Used", namespace = "http://openprovenance.org/prov-xml#", propOrder = {
    "effect",
    "role",
    "cause",
    "account",
...
public class Used implements Relation, Equals, HashCode, ToString
{
