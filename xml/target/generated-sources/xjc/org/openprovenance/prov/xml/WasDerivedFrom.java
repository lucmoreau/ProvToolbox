 ...
 *         &lt;element name="cause" type="{http://openprovenance.org/prov-xml#}EntityRef"/>
...
@XmlType(name = "WasDerivedFrom", namespace = "http://openprovenance.org/prov-xml#", propOrder = {
    "effect",
    "cause",
    "account",
    "time",
...
public class WasDerivedFrom implements Relation, Equals, HashCode, ToString
{

    @XmlElement(namespace = "http://openprovenance.org/prov-xml#", required = true)
    protected EntityRef effect;
    @XmlElement(namespace = "http://openprovenance.org/prov-xml#", required = true)
    protected EntityRef cause;
     ...
     *     
     */
    public void setCause(EntityRef value) {
        this.cause = value;
    }
